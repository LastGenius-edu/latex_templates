...
\begin{itemize}
\item \textcolor{white}{\marker[ucuyellow]{\texttt{ucuyellow}}}
\item \textcolor{white}{\marker[ucugrey]{\texttt{ucugrey}}}
\item \textcolor{white}{\marker[ucuwhite]{\texttt{ucuwhite}}}
\item \textcolor{white}{\marker[ucugreyish]{\texttt{ucugreyish}}}
\end{itemize}

\vskip 0.5cm

You can use these colors as you want in your presentation. For example, you can \textbf{\textcolor{ucuyellow}{color the text in yellow}} by writing \texttt{\textbackslash textcolor\{ucuyellow\}\{my yellow text\}}.
...
\begin{verbatim}
\framecard{A SECTION\\TITLE}
\framecard[ucugrey]{A SECTION TITLE\\
WITH A CUSTOM COLOR}
\end{verbatim}
...
\framecard[ucugrey]{A SECTION TITLE\\\vspace{3pt}WITH A CUSTOM COLOR}
...
\end{verbatim}
\item[\texttt{marker}] you can use \texttt{\textbackslash marker} to highlight some text. The default color is \marker{pink}, but you can also \marker[ucuyellow]{use a custom color}. For example:
\begin{verbatim}
\marker{Default color}
\marker[ucuyellow]{Custom Color}
\end{verbatim}
