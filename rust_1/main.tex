...
\begin{frame}{Ownership and lifetimes}
	...
	\begin{itemize}[label=$\bullet$]
		...
		\item A reference cannot outlive its referent
		\item A mutable reference cannot be aliased\\
			(You can only move the value to a new owner)
	\end{itemize}
	\vspace{0.5cm}
\end{frame}
...
\begin{frame}{Ownership and lifetimes}
	\framesubtitle{Examples}
	\large
	\textcolor{ucured}{I've got to add more examples!}
\end{frame}
